...
class ProjectsApi
{
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Aurigma\Storefront\Model\ProjectStatusDto|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto
     */
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Aurigma\Storefront\Model\ProjectStatusDto|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectsChangeStatusWithHttpInfo($id, $transition, $tenant_id = null, string $contentType = self::contentTypes['projectsChangeStatus'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                ...
                case 409:
                    if ('\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }
            ...
            switch ($e->getCode()) {
                ...
                case 409:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Aurigma\Storefront\Model\ProjectStatusTransitionConflictDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto
     */
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function projectsGetAllTransitionsWithHttpInfo($tenant_id = null, string $contentType = self::contentTypes['projectsGetAllTransitions'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\GeneralConflictDto
     */
     ...
     * @throws \Aurigma\Storefront\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\MicrosoftAspNetCoreMvcProblemDetails|\Aurigma\Storefront\Model\GeneralConflictDto, HTTP status code, HTTP response headers (array of strings)
     */
