...
| [**productReferencesGetPersonalizationParameters()**](ProductReferencesApi.md#productReferencesGetPersonalizationParameters) | **GET** /api/storefront/v1/product-references/{reference}/personalization-parameters | Returns a personalization parameters by the storefront product reference. |
