...
```php
projectsGetAllTransitions($tenant_id): \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto
```
...
[**\Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto**](../Model/PagedOfProjectStatusTransitionDto.md)
...
```php
projectsGetAvailableTransitions($id, $tenant_id): \Aurigma\Storefront\Model\PagedOfProjectStatusTransitionDto
```
