# # ProjectsCreateWithSingleItemRequest

## Properties

Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**product_reference** | **string** | Product reference (i.e external reference to Customer&#39;s Canvas product specification - main subject of this project). | [optional]
...
**order_name** | **string** | Order name in ecommerce system. | [optional]
